...
public class EventDB {
    ...
    public EventDB(String eventId, String personId, String faceId, String fingerId, String cardNo, String facePath, int machineId, String accessDate, String accessTime, String accessType, double temperature, int gender, int age, int wearMask, double scoreMatch, String errorCode, int status, String note) {
